...
function tcdhl(){
	...
	function huadong(dao){
		...
		hddbt = setInterval(function(){
			var i=document.documentElement.scrollTop-(document.documentElement.scrollTop%100);
			if(i==dao){
				clearInterval(hddbt);
			}else if(document.documentElement.scrollTop>dao) {
	...
	for(var i=0;i<aspdhdd.length;i++) {
		...
		aspdhdd[i].onclick = function(){
			var indx = this.ind;
			switch(indx){
				case 0: huadong(800);break;
				case 1: huadong(1600);break;
				case 2: huadong(2000);break;
				case 3: huadong(2400);break;
				case 4: huadong(2800);break;
				case 5: huadong(3200);break;
				case 6: huadong(3500);break;
			}
		}
